...
Welcome to ytdl-go! This is a powerful, fast, and feature-rich downloader for YouTube and YouTube Music, made easy for you to use. Follow these simple steps to get started.
...
3. Download the file that matches your operating system. You might see options like Windows, macOS, or Linux.
4. After the download is complete, find the downloaded file on your computer.
5. Follow the installation steps outlined below specific to your operating system.
...
2. Double-click the file. This will begin the installation.
3. Follow the prompts to complete the installation.
4. Once installed, open Command Prompt by searching for "cmd" in the Start menu.
5. Type `ytdl-go` and press Enter. This will run the application.

### macOS

1. Locate the downloaded `.dmg` file.
2. Double-click the file to open it.
3. Drag the ytdl-go icon into your Applications folder.
4. Open Terminal by searching for it via Spotlight.
5. Type `ytdl-go` and hit Enter to run the application.
...
After installation, you can start using ytdl-go to download videos. Here’s how to use it:

1. Open the Command Prompt (Windows) or Terminal (macOS/Linux).
2. Type the command `ytdl-go [options] <URL>` to download a video. Replace `<URL>` with the actual link of the YouTube video or playlist you want to download.
3. Options will help you customize your download. Here are some common options:
   - `--audio`: to download audio only.
...
ytdl-go works on the following systems:
...
- Fast downloading speed for both audio and video.
- Support for playlists, making it easy to download music collections.
